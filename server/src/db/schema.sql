...
INSERT INTO "exams" ("id", "title", "status", "duration", "extraTime", "allowedMaterials", "teacherAvailable", "questions") VALUES
(1, 'Math Exam', 'published', 60, 15, 'Calculator', 'First 20 minutes of the exam', '[{"id": "q1", "text": "What is 2 + 2?", "answer": "4", "options": ["3", "4", "5", "6"]}, {"id": "q2", "text": "What is 5 * 3?", "answer": "15", "options": ["10", "15", "20", "25"]}, {"id": "q3", "text": "What is 10 - 4?", "answer": "6", "options": ["4", "5", "6", "7"]}]'::jsonb),
(2, 'English Exam', 'published', 45, 10, 'Dictionary', 'First 15 minutes of the exam', '[{"id": "q1", "text": "Choose the correct word: I ___ happy.", "answer": "am", "options": ["am", "is", "are", "be"]}, {"id": "q2", "text": "What is the opposite of hot?", "answer": "cold", "options": ["warm", "cold", "big", "fast"]}, {"id": "q3", "text": "Choose the correct plural: child", "answer": "children", "options": ["childs", "children", "childes", "childrens"]}, {"id": "q4", "text": "Which sentence is correct?", "answer": "She goes to school every day.", "options": ["She go to school every day.", "She goes to school every day.", "She going to school every day.", "She gone to school every day."]}]'::jsonb),
(3, 'Computer Science Exam', 'draft', 90, 20, 'Course notes', 'First 30 minutes of the exam', '[{"id": "q1", "text": "Which data structure uses FIFO?", "answer": "Queue", "options": ["Stack", "Queue", "Tree", "Graph"]}, {"id": "q2", "text": "What does HTML stand for?", "answer": "Hyper Text Markup Language", "options": ["Hyper Text Markup Language", "High Text Machine Language", "Hyper Tool Multi Language", "Home Text Markup Language"]}, {"id": "q3", "text": "Which symbol is used for a single-line comment in JavaScript?", "answer": "//", "options": ["//", "/* */", "#", "--"]}]'::jsonb),
(4, 'MATH 3', 'draft', 120, 15, 'No materials', 'First 20 minutes of the exam', '[{"id": 1, "text": "2+2+4", "answer": "8", "options": ["6", "8", "7", "1"]}]'::jsonb),
(5, 'math 9', 'draft', 60, 15, '', 'First 20 minutes of the exam', '[{"id": 1, "text": "7+7+7", "answer": "21", "options": ["21", "12", "0", "4"]}]'::jsonb);

SELECT setval('"exams_id_seq"', (SELECT MAX("id") FROM "exams"));

INSERT INTO "studentScores" ("id", "studentName", "examId", "examTitle", "score", "totalQuestions", "grade", "date") VALUES
(1, 'Noor Ahmed', 1, 'Math Exam', 3, 3, 100, '2026-06-02'),
(2, 'Lina Mansour', 1, 'Math Exam', 2, 3, 67, '2026-06-02'),
(3, 'Adam Saleh', 2, 'English Exam', 2, 4, 50, '2026-06-02'),
(4, 'Noor Ahmed', 2, 'English Exam', 4, 4, 100, '2026-06-03'),
(5, 'Lina Mansour', 2, 'English Exam', 3, 4, 75, '2026-06-03'),
(6, 'Adam Saleh', 1, 'Math Exam', 3, 3, 100, '2026-06-04'),
(7, 'Noor Ahmed', 3, 'Computer Science Exam', 2, 3, 67, '2026-06-04');
